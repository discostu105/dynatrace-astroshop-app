  ...
  if (products.length === 0) {
    return (
      ...
      >
        ...
        <div style={{ fontSize: '20px', fontWeight: '600' }}>No products match your filters</div>
        <div style={{ fontSize: '14px', color: 'var(--dt-colors-text-secondary-default)' }}>
        ...
        <DataTable.DefaultCell>
          {value ? (
            <Flex alignItems="center" gap={6}>
              <span style={{ color: 'rgba(44, 165, 44, 1)', fontSize: '16px' }}>●</span>
              <span style={{ color: 'rgba(44, 165, 44, 1)', fontWeight: '600' }}>In Stock</span>
            </Flex>
          ) : (
            <Flex alignItems="center" gap={6}>
              <span style={{ color: 'rgba(239, 83, 80, 1)', fontSize: '16px' }}>●</span>
              <span style={{ color: 'rgba(239, 83, 80, 1)', fontWeight: '600' }}>Out of Stock</span>
            </Flex>
          )}
        </DataTable.DefaultCell>
      ),
