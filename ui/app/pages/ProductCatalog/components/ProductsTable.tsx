...
const StockChip = ({ count }: { count: number }) => (
  <div
    style={{
      ...
      borderRadius: '12px',
      backgroundColor:
        count === 0 ? 'rgba(239, 83, 80, 0.1)' : 'var(--dt-colors-background-surface-default)',
      border: count === 0 ? '1px solid rgba(239, 83, 80, 0.3)' : '1px solid var(--dt-colors-border-neutral-default)',
      color: count === 0 ? 'var(--dt-colors-charts-categorical-sunrise-default)' : 'var(--dt-colors-text-primary-default)',
      fontWeight: '600',
      fontSize: '14px',
    }}
  >
...
const StatusBadge = ({ available }: { available: boolean }) => (
  <div
    style={{
      ...
      padding: '4px 12px',
      borderRadius: '12px',
      backgroundColor: available ? 'rgba(44, 165, 44, 0.1)' : 'rgba(239, 83, 80, 0.1)',
      color: available
