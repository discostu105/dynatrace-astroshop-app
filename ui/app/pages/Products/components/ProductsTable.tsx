  ...
  const columns = [
    ...
    },
    {
      ...
      cell: ({ value }: any) => (
        <DataTable.DefaultCell>
          {value > 0 ? (
            <Text style={{ color: "var(--dt-colors-text-link-default)", fontWeight: "600" }}>
              {value}
            </Text>
          ) : (
            <div style={{ 
              ...
              <Text style={{ fontSize: "12px", color: "var(--dt-colors-text-secondary-default)" }}>0</Text>
            </div>
          )}
        </DataTable.DefaultCell>
      ),
        ...
        <DataTable.DefaultCell>
          {value ? (
            <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
              ...
              <Text style={{ color: "var(--dt-colors-charts-status-success-default)", fontWeight: "500" }}>
                In Stock
              </Text>
            </div>
          ) : (
    ...
    },
    {
      ...
      cell: ({ value }: any) => (
        <DataTable.DefaultCell>
          <Button 
            variant="default"
            onClick={() => console.log("Edit product", value)}
          >
            Edit
          </Button>
        </DataTable.DefaultCell>
  ...
  if (products.length === 0) {
    return (
      <div style={{ padding: "64px", textAlign: "center" }}>
        ...
        <Text style={{ fontSize: "16px", fontWeight: "600", marginBottom: "8px" }}>No products found</Text>
        <Text style={{ fontSize: "14px", color: "var(--dt-colors-text-secondary-default)" }}>Try adjusting your filters</Text>
      </div>
    );
  }
